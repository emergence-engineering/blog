...
const TwOpenSource: FunctionComponent = () => {
  return (
    <div className="flex w-full flex-col items-center bg-paper px-3 py-12 text-black sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] lg:py-16 xl:max-w-[1140px] 2xl:max-w-[1320px]">
