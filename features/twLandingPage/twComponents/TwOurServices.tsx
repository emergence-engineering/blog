...
export const TwOurServices: FC = () => {
  return (
    <div
      ...
      className="flex w-full flex-col items-center justify-center gap-12 self-center px-3 py-12 font-bold text-black sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] lg:gap-16 lg:py-16 xl:max-w-[1140px] 2xl:max-w-[1320px]"
    >
