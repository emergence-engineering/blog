    ...
    <div className="flex w-full flex-grow flex-col justify-center bg-black">
      <div className="relative flex">
        ...
        <div className="z-10 flex w-full flex-col items-center justify-center gap-10 pt-3 text-amber-50 lg:pt-16">
          ...
          <div className="flex w-full flex-col gap-5 px-3 sm:max-w-[540px] md:max-w-[720px] md:flex-row md:justify-center lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px]">
            <Button
              theme="secondary"
