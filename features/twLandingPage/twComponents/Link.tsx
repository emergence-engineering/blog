...
export const Link: FC<LinkProps> = ({ href, label, website }) => {
  ...
  return (
    <motion.a
      href={href}
      className="flex max-w-fit items-center justify-end gap-2 self-end bg-gradient-to-r from-red-600 via-orange-500 to-amber-300 bg-clip-text font-bold uppercase text-transparent"
      whileHover={{
