...
export const TwReferences: FC = () => {
  ...
  return (
    <div className="flex w-full justify-center bg-black">
      <div className="flex w-full flex-col items-center justify-center gap-12 px-3 py-12 text-left text-white sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] lg:gap-16 lg:py-16 xl:max-w-[1140px] 2xl:max-w-[1320px]">
