...
export const TwOurProducts: FC = () => {
  return (
    <div className="mb-4 flex h-full w-full flex-col items-center justify-center gap-12 self-center bg-white py-12 sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] lg:gap-16 lg:py-16 xl:max-w-[1140px] 2xl:max-w-[1320px]">
