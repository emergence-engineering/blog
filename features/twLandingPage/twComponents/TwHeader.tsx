  ...
  return (
    <Headroom className="z-30 w-full">
      <div className="flex w-full justify-center border-b-2 border-neutral-700 bg-black">
        <div className="grid w-full grid-flow-col items-center justify-between py-3 sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] lg:py-2 xl:max-w-[1140px] 2xl:max-w-[1320px]">
          <Link href="/">
