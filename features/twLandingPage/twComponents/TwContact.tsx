  ...
  return (
    <div className="justify-centera flex w-full flex-col items-center bg-black text-white">
      <div className="relative flex w-full justify-center">
        ...
        <div className="z-10 flex w-full flex-col justify-center gap-16 py-3 sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] xl:p-36 2xl:max-w-[1320px]">
          <div
