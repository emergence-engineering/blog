    ...
    (async () => {
      ...
      DBS.serverDB
        ...
        .on("change", async data => {
          ...
          const syncDoc: PMDocument = (await DBS.serverDB.get(clientStep.docId)) as any;
          ...
          await DBS.serverDB.bulkDocs(serverSteps);
          await DBS.serverDB.put(newDoc);
