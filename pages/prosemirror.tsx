...
const Index: FunctionComponent = () => {
  return (
    <TwLayout>
      ...
      <div className="flex w-full flex-col items-center gap-4 bg-white px-3 pb-8 sm:max-w-[540px] md:max-w-[720px] md:pb-16 lg:max-w-[960px] xl:max-w-[1140px] 2xl:max-w-[1320px]">
